...
with col_right:
    ...
    ventas_region = df_filtrado.groupby('Región')['Total'].sum().reset_index()
    fig = px.pie(ventas_region, values='Total', names='Región', hole=0.4)
    st.plotly_chart(fig, use_container_width=True)
...
!pip install streamlit pandas numpy plotly-express -qqq

!kill $(lsof -t -i:8501) 2>/dev/null

!streamlit run app.py

"""Ahora deberías ver las URLs de acceso público y de red en la salida de la celda de arriba."""

!streamlit run app.py &>/dev/null&

"""En la salida del shell, se te proporcionará una URL pública y una URL de red. Puedes acceder a la aplicación Streamlit utilizando cualquiera de estas URL."""